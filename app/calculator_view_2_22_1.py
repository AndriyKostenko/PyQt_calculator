from PyQt5.QtWidgets import QPushButton, QMainWindow, QWidget, QVBoxLayout, QLineEdit, QGridLayout
...
class CalcView(QMainWindow):
    ...
    def __init__(self):
        ...
        self.setWindowTitle('Andrew\'s calculator')
    ...
    def _create_display(self):
        ...
        self.display.setStyleSheet('font-size: 28pt; color: blue;')
    ...
    def _create_buttons(self):
        ...
        for t_btn, coord in button_coords.items():
            ...
            q_btn.setStyleSheet('font-size: 30pt; color: orange;')
